...
new PropsConfigData(103, "威力药水", 1, 17, 20, 0, 0, "icon_potion_health_small", "", "models/items/torchFire", 999, false, 0, "威力药水", "", "", 0),

new PropsConfigData(104, "气泡药水", 1, 18, 20, 0, 0, "icon_potion_health_small", "", "models/items/manapotion", 999, false, 0, "气泡数量", "", "", 0),

new PropsConfigData(105, "鞋子", 1, 19, 20, 0, 0, "icon_potion_health_small", "", "models/items/booticon", 999, false, 0, "鞋子", "", "", 0),

new PropsConfigData(106, "连发子弹", 1, 20, 20, 0, 0, "icon_potion_health_small", "", "models/items/manapotion", 999, false, 0, "子弹", "", "", 0),

new PropsConfigData(107, "攻击燃油", 1, 21, 20, 0, 0, "icon_potion_health_small", "", "models/items/potion_old", 999, false, 0, "子弹", "", "", 0),

new PropsConfigData(108, "润滑机油", 1, 22, 20, 0, 0, "icon_potion_health_small", "", "models/items/potion_Armourer", 999, false, 0, "子弹", "", "", 0),

new PropsConfigData(109, "超能子弹", 1, 23, 20, 0, 0, "icon_potion_health_small", "", "models/items/superShootPotion", 999, false, 0, "子弹", "", "", 0),

new PropsConfigData(110, "反雷达装置", 1, 24, 20, 0, 0, "icon_potion_health_small", "", "models/items/HidePotion", 999, false, 0, "子弹", "", "", 0),

new PropsConfigData(111, "核弹", 1, 25, 20, 0, 0, "icon_potion_health_small", "", "models/items/NuclearPotion", 999, false, 0, "子弹", "", "", 0),

new PropsConfigData(112, "弹射器", 1, 26, 20, 0, 0, "icon_potion_health_small", "", "models/items/KnockPotion", 999, false, 0, "子弹", "", "", 0),

new PropsConfigData(113, "防护装置", 1, 27, 20, 0, 0, "icon_potion_health_small", "", "models/items/WuDiPotion", 999, false, 0, "子弹", "", "", 0),

new PropsConfigData(114, "导弹", 1, 28, 20, 0, 0, "icon_potion_health_small", "", "models/items/DaoDan", 999, false, 0, "子弹", "", "", 0),

new PropsConfigData(115, "激光发射器", 1, 29, 20, 0, 0, "icon_potion_health_small", "", "models/items/Laser", 999, false, 168, "子弹", "", "", 0),

new PropsConfigData(116, "引力发生器", 1, 29, 20, 0, 0, "icon_potion_health_small", "", "models/items/GouSuo", 999, false, 171, "子弹", "", "", 0),
