...
new SkillEffectConfigData(3001, 3, 1, "冲击技能", 100, 20),

new SkillEffectConfigData(3002, 3, 2, "冲击技能", 150, 20),

new SkillEffectConfigData(3003, 3, 3, "冲击技能", 200, 20),

new SkillEffectConfigData(3004, 3, 4, "冲击技能", 250, 20),

new SkillEffectConfigData(3005, 3, 5, "冲击技能", 300, 20),

new SkillEffectConfigData(3006, 3, 6, "冲击技能", 350, 20),

new SkillEffectConfigData(3007, 3, 7, "冲击技能", 400, 20),

new SkillEffectConfigData(3008, 3, 8, "冲击技能", 450, 20),

new SkillEffectConfigData(3009, 3, 9, "冲击技能", 500, 20),

new SkillEffectConfigData(3010, 3, 10, "冲击技能", 550, 20),

new SkillEffectConfigData(4001, 4, 1, "重劈", 75, 0),

new SkillEffectConfigData(4002, 4, 2, "重劈", 80, 0),

new SkillEffectConfigData(4003, 4, 3, "重劈", 85, 0),

new SkillEffectConfigData(4004, 4, 4, "重劈", 90, 0),

new SkillEffectConfigData(4005, 4, 5, "重劈", 95, 0),

new SkillEffectConfigData(4006, 4, 6, "重劈", 100, 0),

new SkillEffectConfigData(4007, 4, 7, "重劈", 105, 0),

new SkillEffectConfigData(4008, 4, 8, "重劈", 110, 0),

new SkillEffectConfigData(4009, 4, 9, "重劈", 115, 0),

new SkillEffectConfigData(4010, 4, 10, "重劈", 120, 0),
